...
export default class App extends Component {
  ...
  render() {
    const { news, totalData, turkeyData, allData } = this.state;
    return (
      <Router>
        <div className="app-container">
          ...
          <Switch>
            <Route
              ...
              exact
              render={(props) => (
                <Dashboard news={news} totalData={totalData} turkeyData={turkeyData} allData={allData}></Dashboard>
              )}
            ></Route>
